...
public class RedBlackTree<T> {
    ...
    private   Node createBlackNode(T data) {
        Node node = new Node();
        node.data = data;
    ...
    private   Node createRedNode(Node parent, T data) {
        Node node = new Node();
        node.data = data;
...
/*
    ...
    */
    ...
    private Node insert(Node parent, Node root, T data) {
    ...
    private void delete(Node root, T data, AtomicReference<Node> rootReference) {
        if(root == null || root.isNullLeaf) {
            return;
        }
        if(root.data == data) {
